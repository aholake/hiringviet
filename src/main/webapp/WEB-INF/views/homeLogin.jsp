...
<body>
								...
								<div class="col s9">
									...
									<div class="job-info">
										<div class="row">
											...
											<div class="col m6 none-padding-left">
												<span class="right">Số lượng: 
													<span class="info">5 người</span>
												</span>
											</div>
										</div>
										<div class="row">
				...
				<div class="card-panel center">
					...
					<div class="panel-content">
						<div class="activity-box">
							<p><a href="#">Công ty TNHH MTV</a> vừa đăng 1 <a href="">công việc</a> mới </p>
							<p class="small-text">
								Xây dựng các ứng dụng trên Android cho các hệ thống tài chính, Ngân hàng.Nghiên cứu, tìm kiếm giải pháp <a href="">xem thêm...</a>
							</p>
							<div class="row none-margin-bottom margin-top-5">
								<i class="material-icons left warning-text">favorite</i>
								<span class="small-text right">Hôm qua</span>
							</div>
						</div>
						<div class="activity-box">
							<p><a href="#">Công ty TNHH MTV</a> vừa đăng 1 hoạt động mới </p>
							<p class="small-text">
								Ngày hội việc làm sẽ được tổ chức ngày 20/4/2014, đăng ký tại <a href="#">www.abc.com</a>
							</p>
							<div class="row none-margin-bottom margin-top-5">
								<i class="material-icons left warning-text">favorite</i>
								<span class="small-text right">Hôm qua</span>
	...
	<div id="footer">
		Copyright 2016 by Nong Lam University, all right reserved.
	</div>
	<!-- Local js -->

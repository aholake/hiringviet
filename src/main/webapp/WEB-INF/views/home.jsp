								...
								<div class="col m9">
									...
									<div class="small-text">
										<p class="col s12 none-padding-left">
											<i class="material-icons prefix-icon">flag</i>Quốc gia: 
											<span class="info">Mỹ</span>
										</p>
										<p class="col s12 none-padding-left">
											<i class="material-icons prefix-icon">equalizer</i>Quy mô: 
											<span class="info">200-500 người</span>
										</p>
										<p class="col s12 none-padding-left">
											<i class="material-icons prefix-icon">web</i>Website: 

...
function showResultJobHot(response) {
	...
	if (FAIL == response.result) {
		...
		for (var index = 0; index < jobListResponse.length; index++) {
			...
			var item = '<div class="">\
							<div class="job-box">\
								<div class="location-sticky orange darken-1">' + jobListResponse[index].company.address.province.provinceName + '</div>\
									...
									<div class="col m9">\
										...
										<p class="work-location"><a href="#">' + jobListResponse[index].company.address.province.provinceName + '</a></p>\
										<div class="job-info">\
											<div class="row">\
